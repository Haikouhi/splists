            ...
            <div class="sidebar-sticky">
                <ul class="nav flex-column">
                    ...
                    <li class="ml-2">
                        ...
                        <button class="btn btn-sm btn-primary" type="button" data-toggle="modal" data-target="#formList">Nouvelle liste</a>
